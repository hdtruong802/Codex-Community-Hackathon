...
Sử Việt AI là sản phẩm trò chuyện lịch sử Việt Nam, cho phép người dùng đối thoại với các danh nhân lịch sử dưới dạng persona. Sản phẩm được định hướng cho Codex Community Hackathon 2026, Track 3: Impact to Vietnam.
...
- Nhân vật AI trả lời theo persona, có guardrails lịch sử và nguồn tham khảo.
...
- Mô hình ngôn ngữ có thể khiến lịch sử hấp dẫn hơn, nhưng nếu không kiểm soát sẽ dễ bịa sự kiện.
...
- Trợ lý trò chuyện là hình thức học tự nhiên: người dùng hỏi điều mình tò mò.
...
- Luôn nhắc rõ đây là nhân vật AI mô phỏng, không phải sử liệu chính thức hay phát ngôn thật.
...
- Biết đâu là phần AI mô phỏng và đâu là thông tin cần kiểm chứng thêm.
...
MVP của Sử Việt AI là một web app gồm:
...
- Disclaimer nhân vật AI mô phỏng.
...
6. Nhân vật mô phỏng trả lời theo persona, stream từng đoạn.
...
- Message list: user bubble bên phải, character bubble bên trái.
...
- Message người dùng và nhân vật hiển thị phân biệt rõ.
- Nhân vật trả lời bằng tiếng Việt.
- Persona phù hợp với nhân vật.
- Có retry/error state khi lỗi.

### FR4. Streaming Response

Câu trả lời từ nhân vật được stream từng phần.
...
Câu trả lời cần kèm nguồn sử liệu hoặc khuyến nghị tra cứu.

Tiêu chí chấp nhận:

- Message của nhân vật có vùng nguồn/fact box khi phù hợp.
- Nội dung nguồn có thể gồm Đại Việt Sử Ký Toàn Thư, An Nam Chí Lược, thơ văn gốc hoặc khuyến nghị tra cứu sử sách.
- Nếu hệ thống không chắc, phải nói rõ thay vì bịa.
...
- Nếu hỏi về sự kiện sau năm mất/thời đại của nhân vật, nhân vật nói không biết vì không còn ở thế gian hoặc không thuộc thời mình.
- Nếu hỏi về công nghệ/hiện đại, nhân vật bày tỏ tò mò và liên hệ với trải nghiệm thời mình.
- Nếu thiếu chắc chắn, nhân vật nói "không nhớ rõ" hoặc khuyến nghị tra cứu thêm.
...
Sản phẩm phải cảnh báo rõ đây là nhân vật AI mô phỏng.

Tiêu chí chấp nhận:

- Có disclaimer banner hoặc text cố định.
- Nội dung không gây hiểu nhầm rằng đây là phát ngôn thật của nhân vật lịch sử.
- About page nhắc lại giới hạn này.

### FR10. Conversation History

Hệ thống cần nhớ ngữ cảnh hội thoại gần nhất.
...
### 11.5. Response Contract Cho Model
...
- Dark theme premium.
- Cảm hứng từ các sản phẩm chat hiện đại.
...
- Sử Việt AI cho phép trực tiếp trò chuyện với nhân vật lịch sử.
...
5. Chỉ ra câu trả lời streaming, đúng giọng nhân vật, có sử liệu.
...
- Đây không chỉ là câu trả lời chung chung.
...
- Sử Việt AI muốn biến lịch sử từ nội dung học thuộc thành cuộc trò chuyện.
...
- Có disclaimer nhân vật AI mô phỏng.
- Có source/fact-check box hoặc khuyến nghị tra cứu.
- Có RAG MVP cho 3 nhân vật, tối thiểu 10 chunks/nhân vật.
- Khi không có evidence đủ tốt, hệ thống biết nói không đủ sử liệu thay vì bịa.
...
| Model hallucinate | Trung bình | Giảm temperature, thêm guardrail "không bịa sự kiện" |
...
- Source/fact-check box hiển thị trong message của nhân vật.
